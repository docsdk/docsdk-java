...
public abstract class AbstractSettingsProvider implements SettingsProvider {
    ...
    public static final String API_KEY = "DOCSDK_API_KEY";
    public static final String USE_SANDBOX = "DOCSDK_SANDBOX";
    public static final String WEBHOOK_SIGNING_SECRET = "DOCSDK_WEBHOOK_SIGNING_SECRET";

    public static final String API_URL_SANDBOX = "https://api.sandbox.docsdk.com/v2";
    public static final String API_URL_LIVE = "https://api.docsdk.com/v2";
