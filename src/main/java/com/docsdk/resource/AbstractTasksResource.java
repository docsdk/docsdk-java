...
import com.docsdk.resource.params.converter.PaginationToNameValuePairsConverter;
...
public abstract class AbstractTasksResource<TRAR extends AbstractResult<TaskResponse>,
     ...
     * <p>
     * In general, please avoid to block your application until a DocSDK job completes.
