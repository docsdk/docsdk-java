...
public abstract class AbstractImportFilesResource<TRAR extends AbstractResult<TaskResponse>> extends AbstractResource {
     ...
     * It allows your users to directly upload input files to DocSDK, without temporary storing them on your server.
     * <p>
     * Upload file using existing task id and {@link com.docsdk.dto.response.TaskResponse.Result.Form}
     *
     * @param taskId                 task
     * @param taskResponseResultForm {@link com.docsdk.dto.response.TaskResponse.Result.Form}
     * @param file                   {@link File} file which will be uploaded
     * @return
     * @throws IOException
     * @throws URISyntaxException
