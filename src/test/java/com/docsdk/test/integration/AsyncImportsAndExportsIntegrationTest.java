...
public class AsyncImportsAndExportsIntegrationTest extends AbstractTest {
    ...
    public void cancelAndRetryUploadImportTaskLifecycle() throws Exception {
        ...
        final Result<TaskResponse> uploadImportTaskResponseResult = asyncDocSDKClient.importUsing().upload(new UploadImportRequest()).get();
        ...
        // Cancel
        final Result<TaskResponse> cancelUploadImportTaskResponseResult = asyncDocSDKClient.tasks().cancel(uploadImportTaskResponse.getId()).get();
        ...
        // Retry
        final AsyncResult<TaskResponse> retryUploadImportTaskResponseAsyncResult = asyncDocSDKClient.tasks().retry(uploadImportTaskResponse.getId());
        ...
        final Result<TaskResponse> uploadTaskResponseResult = asyncDocSDKClient.importUsing()
        ...
        // Wait import upload
        final Result<TaskResponse> waitRetryUploadImportTaskResponseResult = asyncDocSDKClient.tasks().wait(retryUploadImportTaskResponse.getId()).get();
    ...
    public void uploadImportInputStreamAndExportUrlTaskLifecycle() throws Exception {
        ...
        // Wait import upload
        final Result<TaskResponse> waitUploadImportTaskResponseResult = asyncDocSDKClient.tasks().wait(uploadImportTaskResponse.getId()).get();
        ...
        final Result<TaskResponse> urlExportTaskResponseResult = asyncDocSDKClient.exportUsing().url(urlExportRequest).get();
        ...
        // Wait export url
        final Result<TaskResponse> waitUrlExportTaskResponseResult = asyncDocSDKClient.tasks().wait(urlExportTaskResponse.getId()).get();
        assertThat(waitUploadImportTaskResponseResult.getStatus()).isEqualTo(HttpStatus.SC_OK);
        ...
        // Download file
        final Result<InputStream> inputStreamResult = asyncDocSDKClient.files().download(waitUrlExportTaskResponse.getResult().getFiles().get(0).get("url")).get();
    ...
    public void uploadImportFileAndExportUrlTaskLifecycle() throws Exception {
        // Import upload (immediate upload)
        final Result<TaskResponse> uploadImportTaskResponseResult = asyncDocSDKClient.importUsing().upload(new UploadImportRequest(), jpgTest1File).get();
        assertThat(uploadImportTaskResponseResult.getStatus()).isEqualTo(HttpStatus.SC_OK);
    ...
    public void importTasksCreation() throws Exception {
        ...
        final Result<TaskResponse> urlImportTaskResponseResult = asyncDocSDKClient.importUsing().url(urlImportRequest).get();
        ...
        final Result<TaskResponse> uploadImportTaskResponseResult = asyncDocSDKClient.importUsing().upload(uploadImportRequest).get();
        assertThat(uploadImportTaskResponseResult.getStatus()).isEqualTo(HttpStatus.SC_CREATED);
        ...
        final Result<TaskResponse> s3ImportTaskResponseResult = asyncDocSDKClient.importUsing().s3(s3ImportRequest).get();
        ...
        final Result<TaskResponse> azureBlobImportTaskResponseResult = asyncDocSDKClient.importUsing().azureBlob(azureBlobImportRequest).get();
        ...
        final Result<TaskResponse> googleCloudStorageImportTaskResponseResult = asyncDocSDKClient.importUsing()
        ...
        final Result<TaskResponse> openStackImportTaskResponseResult = asyncDocSDKClient.importUsing().openStack(openStackImportRequest).get();
        ...
        final Result<TaskResponse> sftpImportTaskResponseResult = asyncDocSDKClient.importUsing().sftp(sftpImportRequest).get();
    ...
    public void exportTasksCreation() throws Exception {
        ...
        final Result<TaskResponse> s3ExportTaskResponseResult = asyncDocSDKClient.exportUsing().s3(s3ExportRequest).get();
        ...
        final AzureBlobExportRequest azureBlobExportRequest = new AzureBlobExportRequest()
            ...
            .setStorageAccessKey("some-storage-access-key").setContainer("some-container").setBlob("some-blob");
        final Result<TaskResponse> azureBlobExportTaskResponseResult = asyncDocSDKClient.exportUsing().azureBlob(azureBlobExportRequest).get();
        ...
        final Result<TaskResponse> googleCloudStorageExportTaskResponseResult = asyncDocSDKClient.exportUsing()
        ...
        final Result<TaskResponse> openStackExportTaskResponseResult = asyncDocSDKClient.exportUsing().openStack(openStackExportRequest).get();
        ...
        final Result<TaskResponse> sftpExportTaskResponseResult = asyncDocSDKClient.exportUsing().sftp(sftpExportRequest).get();
