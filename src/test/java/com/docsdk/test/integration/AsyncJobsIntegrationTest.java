...
public class AsyncJobsIntegrationTest extends AbstractTest {
    ...
    public void mergeFileTaskAsJobLifecycle() throws Exception {
        ...
        // Create job
        final Result<JobResponse> jobResponseResult = asyncDocSDKClient.jobs().create(tasks).get();
        ...
        final Result<TaskResponse> uploadFile1TaskResponseResult = asyncDocSDKClient.importUsing()
        ...
        final Result<TaskResponse> uploadFile2TaskResponseResult = asyncDocSDKClient.importUsing()
        ...
        // Wait
        final Result<JobResponse> waitJobResponseResult = asyncDocSDKClient.jobs().wait(jobResponse.getId()).get();
        ...
        // Show
        final Result<JobResponse> showJobResponseResult = asyncDocSDKClient.jobs().show(jobResponse.getId()).get();
        ...
        // Delete job
        final Result<Void> deleteVoidResult = asyncDocSDKClient.jobs().delete(jobResponse.getId()).get();
    ...
    public void listJobsLifecycle() throws Exception {
        // List jobs
        final Result<Pageable<JobResponse>> jobResponsePageable = asyncDocSDKClient.jobs()
