...
public class JobsIntegrationTest extends AbstractTest {
    ...
    public void mergeFileTaskAsJobLifecycle() throws Exception {
        ...
        // Create job
        final Result<JobResponse> jobResponseResult = docSDKClient.jobs().create(tasks);
        ...
        final Result<TaskResponse> uploadFile1TaskResponseResult = docSDKClient.importUsing()
        ...
        final Result<TaskResponse> uploadFile2TaskResponseResult = docSDKClient.importUsing()
        ...
        // Wait
        final Result<JobResponse> waitJobResponseResult = docSDKClient.jobs().wait(jobResponse.getId());
        ...
        // Show
        final Result<JobResponse> showJobResponseResult = docSDKClient.jobs().show(jobResponse.getId());
        ...
        // Delete job
        final Result<Void> deleteVoidResult = docSDKClient.jobs().delete(jobResponse.getId());
    ...
    public void listJobsLifecycle() throws Exception {
        // List jobs
        final Result<Pageable<JobResponse>> jobResponsePageable = docSDKClient.jobs().list(ImmutableMap.of(), ImmutableList.of(), new Pagination(10, 1));
