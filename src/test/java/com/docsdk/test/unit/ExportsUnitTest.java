...
public class ExportsUnitTest extends AbstractTest {
    ...
    public void export_url() throws Exception {
        ...
        assertThat(docSDKClient.exportUsing().url(expectedUrlExportRequest)).isEqualTo(taskResponseResult);
    ...
    public void export_s3() throws Exception {
        ...
        assertThat(docSDKClient.exportUsing().s3(expectedS3ExportRequest)).isEqualTo(taskResponseResult);
        verify(requestExecutor, times(1)).execute(httpUriRequestArgumentCaptor.capture(), eq(AbstractResource.TASK_RESPONSE_TYPE_REFERENCE));
    ...
    public void export_azureBlob() throws Exception {
        ...
        assertThat(docSDKClient.exportUsing().azureBlob(expectedAzureBlobExportRequest)).isEqualTo(taskResponseResult);
        verify(requestExecutor, times(1)).execute(httpUriRequestArgumentCaptor.capture(), eq(AbstractResource.TASK_RESPONSE_TYPE_REFERENCE));
    ...
    public void export_googleCloudStorage() throws Exception {
        ...
        assertThat(docSDKClient.exportUsing().googleCloudStorage(expectedGoogleCloudStorageExportRequest)).isEqualTo(taskResponseResult);
        verify(requestExecutor, times(1)).execute(httpUriRequestArgumentCaptor.capture(), eq(AbstractResource.TASK_RESPONSE_TYPE_REFERENCE));
    ...
    public void export_openStack() throws Exception {
        ...
        assertThat(docSDKClient.exportUsing().openStack(expectedOpenStackExportRequest)).isEqualTo(taskResponseResult);
        verify(requestExecutor, times(1)).execute(httpUriRequestArgumentCaptor.capture(), eq(AbstractResource.TASK_RESPONSE_TYPE_REFERENCE));
    ...
    public void export_sftp() throws Exception {
        ...
        assertThat(docSDKClient.exportUsing().sftp(expectedSftpExportRequest)).isEqualTo(taskResponseResult);
        verify(requestExecutor, times(1)).execute(httpUriRequestArgumentCaptor.capture(), eq(AbstractResource.TASK_RESPONSE_TYPE_REFERENCE));
