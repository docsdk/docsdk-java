...
public class TasksUnitTest extends AbstractTest {
    ...
    public void tasks_show_noIncludes() throws Exception {
        ...
        assertThat(docSDKClient.tasks().show(TASK_ID)).isEqualTo(taskResponseResult);
    ...
    public void tasks_show_includes() throws Exception {
        ...
        assertThat(docSDKClient.tasks().show(TASK_ID, includes)).isEqualTo(taskResponseResult);
        verify(requestExecutor, times(1)).execute(httpUriRequestArgumentCaptor.capture(), eq(AbstractResource.TASK_RESPONSE_TYPE_REFERENCE));
    ...
    public void tasks_wait() throws Exception {
        ...
        assertThat(docSDKClient.tasks().wait(TASK_ID)).isEqualTo(taskResponseResult);
        verify(requestExecutor, times(1)).execute(httpUriRequestArgumentCaptor.capture(), eq(AbstractResource.TASK_RESPONSE_TYPE_REFERENCE));
    ...
    public void tasks_list_noQueryString() throws Exception {
        ...
        assertThat(docSDKClient.tasks().list()).isEqualTo(taskResponsePageableResult);
    ...
    public void tasks_list_queryString() throws Exception {
        ...
        assertThat(docSDKClient.tasks().list(filters, includes, pagination)).isEqualTo(taskResponsePageableResult);
        verify(requestExecutor, times(1)).execute(httpUriRequestArgumentCaptor.capture(), eq(AbstractResource.TASK_RESPONSE_PAGEABLE_TYPE_REFERENCE));
    ...
    public void tasks_cancel() throws Exception {
        ...
        assertThat(docSDKClient.tasks().cancel(TASK_ID)).isEqualTo(taskResponseResult);
        verify(requestExecutor, times(1)).execute(httpUriRequestArgumentCaptor.capture(), eq(AbstractResource.TASK_RESPONSE_TYPE_REFERENCE));
    ...
    public void tasks_retry() throws Exception {
        ...
        assertThat(docSDKClient.tasks().retry(TASK_ID)).isEqualTo(taskResponseResult);
        verify(requestExecutor, times(1)).execute(httpUriRequestArgumentCaptor.capture(), eq(AbstractResource.TASK_RESPONSE_TYPE_REFERENCE));
    ...
    public void tasks_delete() throws Exception {
        ...
        assertThat(docSDKClient.tasks().delete(TASK_ID)).isEqualTo(voidResult);
    ...
    public void tasks_operations_noQueryString() throws Exception {
        ...
        assertThat(docSDKClient.tasks().operations()).isEqualTo(operationResponsePageableResult);
    ...
    public void tasks_operations_queryString() throws Exception {
        ...
        assertThat(docSDKClient.tasks().operations(filters, includes, alternative)).isEqualTo(operationResponsePageableResult);
        verify(requestExecutor, times(1)).execute(httpUriRequestArgumentCaptor.capture(), eq(AbstractResource.OPERATION_RESPONSE_PAGEABLE_TYPE_REFERENCE));
    ...
    public void tasks_convert() throws Exception {
        ...
        assertThat(docSDKClient.tasks().convert(expectedConvertFilesTaskRequest)).isEqualTo(taskResponseResult);
        verify(requestExecutor, times(1)).execute(httpUriRequestArgumentCaptor.capture(), eq(AbstractResource.TASK_RESPONSE_TYPE_REFERENCE));
    ...
    public void tasks_convertFormats_noQueryString() throws Exception {
        ...
        assertThat(docSDKClient.tasks().convertFormats()).isEqualTo(operationResponsePageableResult);
        verify(requestExecutor, times(1)).execute(httpUriRequestArgumentCaptor.capture(), eq(AbstractResource.OPERATION_RESPONSE_PAGEABLE_TYPE_REFERENCE));
    ...
    public void tasks_convertFormats_queryString() throws Exception {
        ...
        assertThat(docSDKClient.tasks().convertFormats(filters, includes, alternative)).isEqualTo(operationResponsePageableResult);
        verify(requestExecutor, times(1)).execute(httpUriRequestArgumentCaptor.capture(), eq(AbstractResource.OPERATION_RESPONSE_PAGEABLE_TYPE_REFERENCE));
    ...
    public void tasks_optimize() throws Exception {
        ...
        assertThat(docSDKClient.tasks().optimize(expectedOptimizeFilesTaskRequest)).isEqualTo(taskResponseResult);
        verify(requestExecutor, times(1)).execute(httpUriRequestArgumentCaptor.capture(), eq(AbstractResource.TASK_RESPONSE_TYPE_REFERENCE));
    ...
    public void tasks_capture() throws Exception {
        ...
        assertThat(docSDKClient.tasks().capture(expectedCaptureWebsitesTaskRequest)).isEqualTo(taskResponseResult);
        verify(requestExecutor, times(1)).execute(httpUriRequestArgumentCaptor.capture(), eq(AbstractResource.TASK_RESPONSE_TYPE_REFERENCE));
    ...
    public void tasks_merge() throws Exception {
        ...
        assertThat(docSDKClient.tasks().merge(expectedMergeFilesTaskRequest)).isEqualTo(taskResponseResult);
        verify(requestExecutor, times(1)).execute(httpUriRequestArgumentCaptor.capture(), eq(AbstractResource.TASK_RESPONSE_TYPE_REFERENCE));
    ...
    public void tasks_archive() throws Exception {
        ...
        assertThat(docSDKClient.tasks().archive(expectedCreateArchivesTaskRequest)).isEqualTo(taskResponseResult);
        verify(requestExecutor, times(1)).execute(httpUriRequestArgumentCaptor.capture(), eq(AbstractResource.TASK_RESPONSE_TYPE_REFERENCE));
    ...
    public void tasks_command() throws Exception {
        ...
        assertThat(docSDKClient.tasks().command(expectedExecuteCommandsTaskRequest)).isEqualTo(taskResponseResult);
        verify(requestExecutor, times(1)).execute(httpUriRequestArgumentCaptor.capture(), eq(AbstractResource.TASK_RESPONSE_TYPE_REFERENCE));
    ...
    public void tasks_thumbnail() throws Exception {
        ...
        assertThat(docSDKClient.tasks().thumbnail(expectedCreateThumbnailsTaskRequest)).isEqualTo(taskResponseResult);
        verify(requestExecutor, times(1)).execute(httpUriRequestArgumentCaptor.capture(), eq(AbstractResource.TASK_RESPONSE_TYPE_REFERENCE));
    ...
    public void tasks_metadata() throws Exception {
        ...
        assertThat(docSDKClient.tasks().metadata(expectedGetMetadataTaskRequest)).isEqualTo(taskResponseResult);
        verify(requestExecutor, times(1)).execute(httpUriRequestArgumentCaptor.capture(), eq(AbstractResource.TASK_RESPONSE_TYPE_REFERENCE));
